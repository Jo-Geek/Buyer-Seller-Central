...
var Strawberry = function () {
  ...
  this.Sidebar = function (_parent) {
    ...
    this.workspace.show = function (a) {
      $('#' + a).addClass('show');
      $('#' + a).find('[data-dismiss=sidebar]').on('click', function () {
        $(this).closest('.workspace-sidebar').removeClass('show');
      });
    }

    this.workspace.hide = function (a) {
      $('#' + a).removeClass('show');
    }
  ...
  this.buttonSelectToggler = function () {

    $('.btn-select-group').on('click', '.btn', function () {
      console.log(this);
      _ele = $(this);
      _ele.closest('.btn-select-group').find('.btn').removeClass('active');
      _ele.addClass('active');
    })
